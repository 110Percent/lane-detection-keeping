...
\begin{table}[]
	...
	\begin{tabular}{llllll}
		...
		10            & Oblique Convolution & 96.50\%           & 97.42             & N              & None                   \\
	\end{tabular}
...
\begin{center}
	\includegraphics[width=5in]{update_description.png}\\
	\captionof{figure}{Calculating the Vehicles New Position Between Cycles Without New Data} \label{fig:lane_center_determination}
\end{center}
...
\begin{center}
	\includegraphics[width=5in]{stanley_heading_error.png}\\
	\captionof{figure}{Calculation of the Heading Error for the Stanley Controller} \label{fig:stanley_heading_calc}
\end{center}
...
\begin{center}
	\includegraphics[width=5in]{stanley_lateral_error.png}\\
	\captionof{figure}{Calculation of the Lateral Error for the Stanley Controller} \label{fig:stanley_lateral_calc}
\end{center}
...
\begin{center}
	\captionof{table}{Results of the Maximum Heading and Lateral Error for Various K and Speed Values} \label{tab:controller_test_values}
...
\begin{center}
	\includegraphics[width=4in]{waypoints_k-15_v-4.png}\\
	\captionof{figure}{Vehicle Path Compared to Waypoints for k=1.5 1/s and Base Velocity of 4.0 m/s Over Time} \label{fig:waypointsk10v4}
\end{center}

\begin{center}
	\includegraphics[width=4in]{lateral_k-15_v-4.png}\\
	\captionof{figure}{Lateral Error with k=1.5 1/s and Base Velocity of 4.0 m/s Over Time} \label{fig:lateralk10v4}
\end{center}

\begin{center}
	\includegraphics[width=4in]{heading_k-15_v-4.png}\\
	\captionof{figure}{Heading Error with k=1.5 1/s and Base Velocity of 4.0 m/s Over Time} \label{fig:headingk10v4}
\end{center}
